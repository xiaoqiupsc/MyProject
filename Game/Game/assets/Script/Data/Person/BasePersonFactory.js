...
outModule.createOneBasePerson = function (personId) {
    ...
    this._r_attakStrikeLevel = this._r_jsonDataJob.attakStrikeLevel + this._r_attackStrikeLevelC;
    this._r_attackStrikeDamage = this._r_jsonDataJob.attackStrikeDamage + this._r_attackStrikeDamageC;
    this._r_attackStrikeResistane = this._r_jsonDataJob.attackStrikeResistane + this._r_attackStrikeResistanceC;
